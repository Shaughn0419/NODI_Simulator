"""
NODI Interferometric Simulator — Data Objects
...
class OpticalSystem:
    ...
    Attributes:
        ...
        system_efficiency: Overall detection efficiency (retained but not multiplied into formulas).
    ...
    system_efficiency: float = 1.0  # Retained but NOT multiplied into formulas
