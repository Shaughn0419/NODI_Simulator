        ...
        rows.append(
            {
                ...
                "model_or_solver_id": "detector-prob-v1",
                "assumption_manifest_id": "sidewall-detection-assumptions-v1",
                "formula_id": "detection_probability_simulation_formula_v1",
                "validity_domain": "sidewall_route_candidate_simulation",
                "uncertainty_semantics": "binomial_interval_over_simulated_events",
        ...
        rows.append(
            {
                ...
                "route_candidate_id": route_id,
                "source_kind": "simulation_manifest",
                "model_or_solver_id": "yield-model-v1",
                "assumption_manifest_id": "sidewall-yield-assumptions-v1",
                "formula_id": "yield_wet_pass_simulation_formula_v1",
                "validity_domain": "sidewall_route_candidate_simulation",
                "uncertainty_semantics": "binomial_interval_over_simulated_trials",
                "claim_level": "simulation_only",
                "yield_estimate": "0.72",
                "yield_ci_low": "0.66",
                "yield_ci_high": "0.78",
