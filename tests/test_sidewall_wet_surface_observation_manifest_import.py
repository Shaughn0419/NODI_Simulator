        ...
        rows.append(
            {
                ...
                "model_or_solver_id": "wet-surface-sim-v1",
                "assumption_manifest_id": "sidewall-wet-assumptions-v1",
                "validity_domain": "sidewall_route_candidate_simulation",
                "uncertainty_semantics": "simulation_interval_or_endpoint_not_required",
