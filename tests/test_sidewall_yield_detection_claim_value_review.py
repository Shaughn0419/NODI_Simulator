...
def _detection_row(route_id: str = "ROUTE-CAND-001") -> dict[str, str]:
    return {
...
def _yield_row(route_id: str = "ROUTE-CAND-001") -> dict[str, str]:
    return {
        "route_candidate_id": route_id,
        "yield_estimate": "0.72",
        "yield_ci_low": "0.66",
...
def test_claim_value_review_accepts_valid_detection_and_yield_rows() -> None:
    rows, guards = build_yield_detection_claim_value_review(
        winner_jrc_rows=_winner_rows(),
        detection_value_rows=[
            _detection_row("ROUTE-CAND-001"),
            _detection_row("ROUTE-CAND-002"),
        ],
        yield_value_rows=[_yield_row("ROUTE-CAND-001"), _yield_row("ROUTE-CAND-002")],
    )
...
def test_claim_value_review_rejects_bad_intervals_and_controls() -> None:
