...
if __package__ in {None, ""}:
    # Compatibility path for tools like pytest that may import this file as a
    # top-level ``__init__`` module instead of as the ``nodi_simulator`` package.
    from nodi_simulator import *  # type: ignore[F403]
else:
