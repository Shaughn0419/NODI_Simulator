"""P0 EV confinement and integrity-risk diagnostics for package-local use."""
...
from .particle_design_library import _particle_family
...
def build_ev_integrity_risk_diagnostics(
    ...
    *,
    ...
    is_ev_like = _particle_family(particle) == "EV_sEV"
    if not is_ev_like:
