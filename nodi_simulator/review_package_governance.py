...
def write_p1_governance_files(project_root: Path = PROJECT_ROOT) -> list[Path]:
    ...
    supersession_path.write_text(
        ...
        "Report 140 is the current Lens-B EV+gold 3seed × 10000e full-grid post-run analysis. "
        "Report 88 remains the consolidated v1/v2/post-v2 background analysis, but its Lens-B "
        "B6/B7 single-seed language is now superseded/qualified by report 140. From report 88 "
        ...
        "use report 140: `fixed_660_gold` and `per_wavelength_gold` are normalization views over shared "
        ...
        "recommendation conclusions, and 660/404 are the only recommendation-eligible wavelengths. Raw "
        "comparison tables and figures remain unfiltered. Current B2 interpretation is still no-measured-data "
        "Level-1 relative/proxy evidence only.\n\n"
