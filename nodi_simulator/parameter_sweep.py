...
def _build_observation_signature(
    ...
    return (
        ...
        f"|fluidic_clogging_risk_band_claim_level={reference.get('fluidic_clogging_risk_band_claim_level', 'unknown')}"
        f"|not_clogging_rate={reference.get('not_clogging_rate', 'unknown')}"
        f"|not_time_to_clog={reference.get('not_time_to_clog', 'unknown')}"
        f"|fluidic_geometry_model={reference.get('fluidic_geometry_model', 'unknown')}"
        f"|hydraulic_resistance_model={reference.get('hydraulic_resistance_model', 'unknown')}"
        f"|hydraulic_resistance_claim_level={reference.get('hydraulic_resistance_claim_level', 'unknown')}"
        f"|fluidic_geometry_propagation_status={reference.get('fluidic_geometry_propagation_status', 'unknown')}"
        f"|geometry_not_propagated_to_fluidic_resistance={reference.get('geometry_not_propagated_to_fluidic_resistance', 'unknown')}"
        f"|fixed_pressure_diagnostic_status={reference.get('fixed_pressure_diagnostic_status', 'unknown')}"
        f"|fluidic_network_model_status={reference.get('fluidic_network_model_status', 'unknown')}"
        f"|fluidic_network_claim_level={reference.get('fluidic_network_claim_level', 'unknown')}"
        f"|fluidic_network_pressure_flow_relation_status={reference.get('fluidic_network_pressure_flow_relation_status', 'unknown')}"
        f"|fluidic_network_geometry_model={reference.get('fluidic_network_geometry_model', 'unknown')}"
        f"|fluidic_network_hydraulic_resistance_model={reference.get('fluidic_network_hydraulic_resistance_model', 'unknown')}"
        f"|fluidic_network_hydraulic_resistance_claim_level={reference.get('fluidic_network_hydraulic_resistance_claim_level', 'unknown')}"
        f"|fluidic_network_geometry_propagation_status={reference.get('fluidic_network_geometry_propagation_status', 'unknown')}"
        f"|geometry_not_propagated_to_fluidic_network={reference.get('geometry_not_propagated_to_fluidic_network', 'unknown')}"
        f"|fluidic_network_not_qch_weighted={reference.get('fluidic_network_not_qch_weighted', 'unknown')}"
        f"|fluidic_network_fixed_pressure_prediction_allowed={reference.get('fluidic_network_fixed_pressure_prediction_allowed', 'unknown')}"
        f"|fluidic_network_gate_passed={reference.get('fluidic_network_gate_passed', 'unknown')}"
        f"|wall_interaction_model={sim_cfg.wall_interaction_model}"
        f"|electrokinetic_model={reference.get('electrokinetic_model', sim_cfg.electrokinetic_model)}"
        f"|electrokinetic_transport_geometry_model={reference.get('electrokinetic_transport_geometry_model', 'unknown')}"
        f"|electrokinetic_wall_distance_model={reference.get('electrokinetic_wall_distance_model', 'unknown')}"
        f"|electrokinetic_geometry_propagation_status={reference.get('electrokinetic_geometry_propagation_status', 'unknown')}"
        f"|geometry_not_propagated_to_electrokinetic_transport={reference.get('geometry_not_propagated_to_electrokinetic_transport', 'unknown')}"
        f"|surface_charge_transport_claim_level={reference.get('surface_charge_transport_claim_level', 'unknown')}"
        f"|electrokinetic_diagnostic_gate_passed={reference.get('electrokinetic_diagnostic_gate_passed', 'unknown')}"
        ...
        f"|sidewall_angle_convention={reference.get('sidewall_angle_convention', 'unknown')}"
        f"|sidewall_deg_comsol={reference.get('sidewall_deg_comsol', 'unknown')}"
        f"|W_top_semantics={reference.get('W_top_semantics', 'unknown')}"
        f"|runtime_top_aperture_nm={reference.get('runtime_top_aperture_nm', 'unknown')}"
        f"|source_geometry_descriptor_sha={reference.get('source_geometry_descriptor_sha', 'unknown')}"
        f"|geometry_profile_sha256={reference.get('geometry_profile_sha256', 'unknown')}"
        f"|geometry_profile_source={reference.get('geometry_profile_source', 'unknown')}"
        f"|geometry_claim_level={reference.get('geometry_claim_level', 'unknown')}"
        f"|metrology_status={reference.get('metrology_status', 'unknown')}"
        f"|geometry_profile_descriptor_version={reference.get('geometry_profile_descriptor_version', 'unknown')}"
        f"|geometry_runtime_binding_version={reference.get('geometry_runtime_binding_version', 'unknown')}"
        f"|corner_radius_nm={float(sim_cfg.corner_radius_nm):.9e}"
        f"|surface_roughness_rms_nm={float(sim_cfg.surface_roughness_rms_nm):.9e}"
        f"|width_along_channel_cv={float(sim_cfg.width_along_channel_cv):.9e}"
        f"|depth_along_channel_cv={float(sim_cfg.depth_along_channel_cv):.9e}"
        f"|measured_profile_path={sim_cfg.measured_profile_path or 'none'}"
        f"|measured_profile_loaded={reference.get('measured_profile_loaded', False)}"
        f"|measured_profile_validated={reference.get('measured_profile_validated', False)}"
        f"|measured_profile_sha256={reference.get('measured_profile_sha256', '')}"
        f"|measured_profile_runtime_status={reference.get('measured_profile_runtime_status', 'not_requested')}"
        ...
        f"|trapezoid_top_width_m={reference.get('trapezoid_top_width_m', 'unknown')}"
        f"|trapezoid_depth_m={reference.get('trapezoid_depth_m', 'unknown')}"
        f"|trapezoid_bottom_width_unclipped_m={reference.get('trapezoid_bottom_width_unclipped_m', 'unknown')}"
        f"|trapezoid_bottom_width_runtime_clipped_m={reference.get('trapezoid_bottom_width_runtime_clipped_m', 'unknown')}"
        ...
        f"|trapezoid_center_accessible_area_m2={reference.get('trapezoid_center_accessible_area_m2', 'unknown')}"
        f"|trapezoid_center_accessible_area_fraction={reference.get('trapezoid_center_accessible_area_fraction', 'unknown')}"
        ...
        f"|brownian_boundary_target_model={reference.get('brownian_boundary_target_model', 'unknown')}"
        f"|brownian_boundary_numerical_scheme={reference.get('brownian_boundary_numerical_scheme', 'unknown')}"
        f"|not_ballistic_specular_collision_claim={reference.get('not_ballistic_specular_collision_claim', 'unknown')}"
        f"|not_hindered_hydrodynamics_claim={reference.get('not_hindered_hydrodynamics_claim', 'unknown')}"
        f"|projection_boundary_surrogate_used={reference.get('projection_boundary_surrogate_used', 'unknown')}"
        f"|reflection_update_rule_id={reference.get('reflection_update_rule_id', 'unknown')}"
        f"|reflection_telemetry_scope={reference.get('reflection_telemetry_scope', 'unknown')}"
        f"|reflection_active_wall_set_reporting={reference.get('reflection_active_wall_set_reporting', 'unknown')}"
        f"|reflection_iteration_count_reporting={reference.get('reflection_iteration_count_reporting', 'unknown')}"
        f"|reflection_displacement_reporting={reference.get('reflection_displacement_reporting', 'unknown')}"
