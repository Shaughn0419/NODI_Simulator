...
def _validate_sidewall_v2_observation_cache_context(
    ...
    *,
    ...
    _validate_observation_signature_float_binding(
        row,
        observation_signature,
        field="sidewall_deg_comsol",
        signature_key="sidewall_deg_comsol",
        row_index=row_index,
        rule_id=rule_id,
        issues=issues,
    )
    ...
    _validate_observation_signature_float_binding(
        ...
        observation_signature,
        field="W_top_nm",
        signature_key="trapezoid_top_width_m",
        multiplier=1.0e-9,
        abs_tol=1.0e-15,
        row_index=row_index,
        rule_id=rule_id,
    ...
    _validate_observation_signature_float_binding(
        ...
        observation_signature,
        field="D_nm",
        signature_key="trapezoid_depth_m",
        multiplier=1.0e-9,
        abs_tol=1.0e-15,
        row_index=row_index,
        rule_id=rule_id,
    ...
    _validate_observation_signature_float_binding(
        row,
        observation_signature,
        field="W_bottom_unclipped_nm",
        signature_key="trapezoid_bottom_width_unclipped_m",
        multiplier=1.0e-9,
        abs_tol=1.0e-15,
        row_index=row_index,
        rule_id=rule_id,
    ...
    _validate_observation_signature_float_binding(
        row,
        observation_signature,
        field="W_bottom_runtime_clipped_nm",
        signature_key="trapezoid_bottom_width_runtime_clipped_m",
        multiplier=1.0e-9,
        abs_tol=1.0e-15,
        row_index=row_index,
        rule_id=rule_id,
    ...
    _validate_observation_signature_field_binding(
        ...
        signature_key="trapezoid_closure_status",
        row_index=row_index,
        rule_id=rule_id,
        issues=issues,
    )
    _validate_observation_signature_field_binding(
        row,
        observation_signature,
        field="closure_policy",
        signature_key="trapezoid_closure_policy",
        row_index=row_index,
        rule_id=rule_id,
        issues=issues,
    )
    _validate_observation_signature_field_binding(
        row,
        observation_signature,
        field="runtime_guard_status",
        signature_key="trapezoid_runtime_guard_status",
        row_index=row_index,
        rule_id=rule_id,
        issues=issues,
    )
    _validate_observation_signature_optional_float_or_unknown_binding(
        ...
        signature_key="runtime_top_aperture_nm",
        row_index=row_index,
        rule_id=rule_id,
        issues=issues,
    )
