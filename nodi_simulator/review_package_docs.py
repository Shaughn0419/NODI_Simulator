...
def write_review_package_readme(project_root: Path = PROJECT_ROOT) -> Path:
    ...
    path.write_text(
        ...
        "2026-05-23 status note: this package README is P0/post-v2 release context, not "
        "the latest Lens-B full-grid conclusion. Current Lens-B full-grid interpretation "
        "is in `reports/140_exhaustive_ev_gold_fullgrid_3seed_10000e_postrun_analysis_20260523.md`; "
        "use report 88 only as consolidated background for this package.\n\n"
