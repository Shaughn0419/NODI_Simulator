"""Package-local particle-channel phase perturbation diagnostics."""
...
from .type_coerce import positive_ratio as _positive_ratio
...
def build_particle_channel_perturbation_diagnostics(
    ...
    *,
    ...
    delta_to_sca = _positive_ratio(
        delta_E_ref_particle,
        E_sca_abs,
        require_finite_denominator=True,
    )
    delta_to_ref = _positive_ratio(
        delta_E_ref_particle,
        E_ref_abs,
        require_finite_denominator=True,
    )
