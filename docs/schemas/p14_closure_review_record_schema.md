# P14 Closure Review Record Schema

Required verdict: `NO P14 BLOCKERS FOUND`.

Required decision: `p14_closed_no_blockers_no_scope_expansion`.

The record binds the P14 solver output manifest and P14 artifact manifest by path and sha256. It is closure evidence only and does not authorize additional solver execution.
...
- `closure_decision`
- `p14_artifact_manifest_sha256`
- `p14_execution_stage`
- `p14_solver_output_manifest_sha256`
