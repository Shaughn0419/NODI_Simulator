# P13 Next Authorization Design Artifact Manifest Schema

Required role: `p13_next_authorization_design_artifact_manifest`.

The manifest enumerates the P13 design registry, design plan, P12 closure binding, next gate record, and manifest itself. It keeps calibrated SNR blocked and absolute LOD blocked; it is not a solver execution artifact.
