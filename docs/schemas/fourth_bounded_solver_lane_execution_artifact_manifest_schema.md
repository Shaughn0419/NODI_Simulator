# Fourth Bounded Solver Lane Artifact Manifest Schema

Required role: `fourth_bounded_solver_lane_execution_artifact_manifest`.

The artifact manifest enumerates the P12 registry, execution plan, P11 authorization binding manifest, trace-only CSV output, output manifest, and manifest itself. It keeps calibrated SNR blocked and absolute LOD blocked; it is not a calibration or route-promotion artifact.
