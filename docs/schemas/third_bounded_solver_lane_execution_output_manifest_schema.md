# P10 Third Bounded Solver Lane Output Manifest Schema

Required role: `third_bounded_solver_lane_output_manifest_trace_only`.

Required output: `results/post_v2_third_bounded_solver_lane_execution/third_bounded_solver_lane_trace_output.csv`.
...
### `results/post_v2_third_bounded_solver_lane_execution/third_bounded_solver_lane_trace_output_manifest.json`
