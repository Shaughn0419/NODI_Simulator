# P15 Next Authorization Gate Record Schema

Required decision: `not_authorized_pending_explicit_future_request`.

Required future phrase: `authorize sixth bounded solver lane execution`.
...
- `instability_observation = p12_to_p14_rank_swap_trace_only`
