# P8 Closure Review Record Schema

Required verdict: `NO P8 BLOCKERS FOUND`.

Required decision: `p8_closed_no_blockers_no_scope_expansion`.
...
- `closure_decision`
- `p8_artifact_manifest_sha256`
- `p8_execution_stage`
- `p8_solver_output_manifest_sha256`
