# P10 Third Bounded Solver Lane Artifact Manifest Schema

Every artifact row must carry the P10 guard fields, path status, and hash role. The artifact manifest excludes its own hash to avoid a self-hash cycle.
