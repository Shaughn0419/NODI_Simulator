# P12 Closure Artifact Manifest Schema

Required role: `p12_closure_artifact_manifest`.

The manifest enumerates the P12 closure registry, closure note, review record, and manifest itself. It keeps calibrated SNR blocked and absolute LOD blocked; it is not a calibration or promotion artifact.
