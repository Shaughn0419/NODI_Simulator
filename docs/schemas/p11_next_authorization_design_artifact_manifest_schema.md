# P11 Next Authorization Design Artifact Manifest Schema

Required role: `p11_next_authorization_design_artifact_manifest`.

The manifest enumerates the P11 design registry, design plan, P10 closure binding, next gate record, and manifest itself. It keeps calibrated SNR blocked and absolute LOD blocked; it is not a solver execution artifact.
