# P12 Closure Review Record Schema

Required verdict: `NO P12 BLOCKERS FOUND`.

Required decision: `p12_closed_no_blockers_no_scope_expansion`.

The record binds the P12 solver output manifest and P12 artifact manifest by path and sha256. It is closure evidence only and does not authorize additional solver execution.
...
- `closure_decision`
- `p12_artifact_manifest_sha256`
- `p12_execution_stage`
- `p12_solver_output_manifest_sha256`
