# Sixth Bounded Solver Lane P15 Authorization Binding Manifest Schema

Required phrase: `authorize sixth bounded solver lane execution`.

Required prior gate decision: `not_authorized_pending_explicit_future_request`.

The binding manifest must bind the P15 next gate record, the P15 P14 closure binding manifest, the P4 route subset, and the P14 trace context by path and sha256.
