# Fifth Bounded Solver Lane Artifact Manifest Schema

Required role: `fifth_bounded_solver_lane_execution_artifact_manifest`.

The artifact manifest enumerates the P14 registry, execution plan, P13 authorization binding manifest, trace-only CSV output, output manifest, and manifest itself. It keeps calibrated SNR blocked and absolute LOD blocked; it is not a calibration or route-promotion artifact.
