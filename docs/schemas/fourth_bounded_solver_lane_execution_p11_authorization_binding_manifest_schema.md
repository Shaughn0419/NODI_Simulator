# Fourth Bounded Solver Lane P11 Authorization Binding Manifest Schema

Required phrase: `authorize fourth bounded solver lane execution`.

Required prior gate decision: `not_authorized_pending_explicit_future_request`.

The binding manifest must bind the P11 next gate record, the P11 P10 closure binding manifest, the P4 route subset, and the P10 trace context by path and sha256.
...
- `bound_route_ids`
- `p10_trace_context_sha256`
- `p11_authorization_gate_record_sha256`
- `p11_gate_prior_decision`
- `p11_p10_closure_binding_manifest_sha256`
