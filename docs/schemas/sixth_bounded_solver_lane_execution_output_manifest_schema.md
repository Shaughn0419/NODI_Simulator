# Sixth Bounded Solver Lane Output Manifest Schema

Required role: `sixth_bounded_solver_lane_output_manifest_trace_only`.

The output manifest must describe exactly three rows. It may expose only rank, rank-percentile, pairwise order, and P14 rank delta as final interpretation fields. Solver-native values are trace-only and not final gates.
...
### `results/post_v2_sixth_bounded_solver_lane_execution/sixth_bounded_solver_lane_trace_output_manifest.json`
