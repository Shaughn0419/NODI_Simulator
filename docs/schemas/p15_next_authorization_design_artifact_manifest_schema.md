# P15 Next Authorization Design Artifact Manifest Schema

Required role: `p15_next_authorization_design_artifact_manifest`.

The manifest enumerates the P15 design registry, design plan, P14 closure binding, next gate record, and manifest itself. It keeps calibrated SNR blocked and absolute LOD blocked; it is not a solver execution artifact.
