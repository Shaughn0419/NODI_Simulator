"""
NODI Interferometric Simulator — Materials Database
...
# Johnson & Christy (1972) — Gold, selected points in 400–700 nm range.
# wavelength in nm (converted to meters in the array below).
...
_GOLD_JC_DATA = {
    ...
    "n_real": np.array([
        1.658, 1.636, 1.562, 1.426, 1.242, 1.040, 0.916, 0.830, 0.740, 0.650,
        0.560, 0.476, 0.397, 0.331, 0.274, 0.235, 0.207, 0.186, 0.170, 0.160,
        0.153, 0.148, 0.145, 0.145, 0.148, 0.154, 0.164, 0.175, 0.188, 0.203, 0.220,
    ], dtype=float),
    "n_imag": np.array([
        1.956, 1.958, 1.940, 1.904, 1.846, 1.770, 1.700, 1.650, 1.610, 1.580,
        1.560, 1.550, 1.550, 1.560, 1.580, 1.610, 1.650, 1.700, 1.760, 1.830,
        1.910, 1.990, 2.080, 2.170, 2.270, 2.370, 2.470, 2.580, 2.690, 2.800, 2.920,
    ], dtype=float),
}
