...
ACCEPTED_BRIDGE_RELEASE_DISPOSITIONS = {
    "PASS_NODI_PACKAGE_C_SIDEWALL_PRESSURE_FLOW_BRIDGE_RELEASE_V1_READY_FOR_COMSOL_RECEIVER_NO_AUTH",
    "PASS_NODI_PACKAGE_C_SIDEWALL_PRESSURE_FLOW_BRIDGE_RELEASE_V1_READY_WITH_FORMAL_QCH_SIDECAR",
}
...
def build_payload() -> dict[str, Any]:
    ...
    status = (
        ...
        in ACCEPTED_BRIDGE_RELEASE_DISPOSITIONS
