...
from nodi_simulator.post_v2_audit import (
    write_extended_pairwise_stability,
    write_pairwise_rank_inversion,
    write_top_candidate_mandatory_audit,
)
...
def main() -> None:
    paths = [
        ...
        write_pairwise_rank_inversion(PROJECT_ROOT),
        write_extended_pairwise_stability(PROJECT_ROOT),
    ]
